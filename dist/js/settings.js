...
function getSettingsDoc(id) {
	switch (id) {
		case 'enabled (VITAL)':
			return "If this box is not checked, the bot will be totally disabled."
		case 'checkCart (RECOMMENDED, BUT WITH RISKS)':
			return "If you use keywords and has found one or more items, this option will let you check your cart before checkout. We recommand you to use this option but please be aware you are risking valuable time."
		case 'autoFill (RECOMMENDED)':
			return "When you are on checkout page (URL: http://supremenewyork.com/checkout), This will autofill all your information"
		case 'autoCheckout (RECOMMENDED)':
			return "The checkout form will be submitted automatically if this option is enabled."
		case 'retryOnFail':
			return "If when you are purchasing you got an error, the bot will try again until payment done <i style=\"color: #D02120;\">(Option \"Auto-fill checkout page and submit it\" must be enabled)</i>"
		case 'nextSize':
		...
		case 'Start when timer goes off':
...
document.title = "Omars Bot v" + chrome.runtime.getManifest().version
